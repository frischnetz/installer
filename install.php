...
$InstallData = array(
    'revo3.1.2-pl'      => array(
        'tree'     => 'Revolution',
        'name'     => 'MODX Revolution 3.1.2 pl Traditional (2025-04-02)',
        'link'     => 'https://modx.s3.amazonaws.com/releases/3.1.2/modx-3.1.2-pl.zip',
        'location' => 'setup/index.php'
    ),
    'revo3.1.1-pl'      => array(
        'tree'     => 'Revolution',
        'name'     => 'MODX Revolution 3.1.1 pl Traditional (2025-02-18)',
        'link'     => 'https://modx.s3.amazonaws.com/releases/3.1.1/modx-3.1.1-pl.zip',
        'location' => 'setup/index.php'
    ),
    'revo3.1.0-pl'      => array(
        'tree'     => 'Revolution',
